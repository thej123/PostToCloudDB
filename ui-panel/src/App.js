...
class App extends Component {
  ...
  // when component mounts, first thing it does is fetch all existing data in out db
  // then we incorporate a polling logic so that we can easily see if out db has 
  ...
  // here is our UI
  // it is easy to understand thier functions when you
